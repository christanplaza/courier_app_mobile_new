...
public class PendingOrdersFragment extends Fragment implements RecyclerViewInterface {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        String url = Global.Root_IP + "courier_app_web/api/job_orders/pending.php";
    ...
    public void onItemClick(int position) {
        Intent intent = new Intent(getActivity().getApplicationContext(), PendingOrderDetails.class);
